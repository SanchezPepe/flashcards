import { reactive, hasInjectionContext, getCurrentInstance, effectScope, ref, markRaw, toRaw, watch, unref, inject, isRef, isReactive, toRef, nextTick, computed, getCurrentScope, onScopeDispose, toRefs, version, watchEffect, isShallow, h, isReadonly, mergeProps, useSSRContext, provide, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, defineAsyncComponent, createApp } from "vue";
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<!--[--><h1 class="text-3xl font-bold underline">Hello world!</h1><div><p>Count: ${ssrInterpolate($setup.counter.count)}</p><button>Increment</button><button>Decrement</button></div><div>`);
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const ErrorComponent = /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/error-component-b1bd024c.js").then((r) => r.default || r));
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/island-renderer-9b231bd7.js").then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
